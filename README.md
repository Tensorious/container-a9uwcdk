...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a9uwcdk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a9uwcdk.containers.anotherwebservice.com/
...
```
git clone git@github.com:Tensorious/container-a9uwcdk.git
cd container-a9uwcdk
```
...
```
docker attach container-a9uwcdk
```
